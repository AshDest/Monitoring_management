...
Route::prefix('/')->middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::get('gl-accounts/edit/{ids}', [App\Http\Controllers\HomeController::class, 'editglaccount'])->name('edit-glaccount');
    Route::get('/classes', [App\Http\Controllers\HomeController::class, 'classeaccount'])->name('classeaccount');
});
