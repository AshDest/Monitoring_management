...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="/home">
            <img alt="Logo" src="assets/media/logos/logo-1-dark.svg" class="h-40px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="/operateurs">
                                ...
                                <span class="menu-title">Operateurs</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="/home">
                                ...
                                <span class="menu-title">Monnaies</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="/villes">
                                ...
                                <span class="menu-title">Villes / Territoires</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="/communes">
                                ...
                                <span class="menu-title">Communes / Chefferies</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="/quartiers">
                                ...
                                <span class="menu-title">Quartiers / Villages</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Comptability</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="/classes">
                                ...
                                <span class="menu-title">Classes des Comptes</span>
                            </a>
                        </div>
                    </div>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="/accountlevel">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen011.svg-->
                                    <span class="svg-icon svg-icon-4">
                                ...
                                <span class="menu-title">Account Level</span>
                            </a>
                        </div>
                    </div>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="{{route('glaccount')}}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen011.svg-->
                                    <span class="svg-icon svg-icon-4">
