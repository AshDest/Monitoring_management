...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="/home">
            <img alt="Logo" src="{{ asset('assets/media/logos/logo-1-dark.svg') }}" class="h-40px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="/{{$structure}}/home"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Caisse Electronique</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="/{{$structure}}/comptes">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen011.svg-->
                                    <span class="svg-icon svg-icon-4">
                                ...
                                <span class="menu-title">Compte Bancaires</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="/{{$structure}}/monnais">
                                ...
                                <span class="menu-title">Mobile Money</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('accounts', ['structure' => $structure]) }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen011.svg-->
                                    <span class="svg-icon svg-icon-4">
                                ...
                                <span class="menu-title">Plan Comptable</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="/{{$structure}}/monnais">
