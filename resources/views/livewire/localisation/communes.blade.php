                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                <tr>
                                    ...
                                    <td>
                                        <a href=""
                                            class="text-gray-800 text-hover-primary mb-1">{{$commune->code}}</a>
                                    </td>
                                    <td>
                                        <a href=""
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" wire:click="delete({{ $commune->id }})">
...
<div class="modal fade" id="add_element_forms" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            @livewire('localisation.communes')
            <!--end::Form-->
        </div>
    </div>
</div>
