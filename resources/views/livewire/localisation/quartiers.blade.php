                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">CODE QUARTIER</th>
                                <th class="min-w-125px">NOMINATION QUARTIER</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="{{$quartier->id}}" />
                                    </div>
                                </td>
                                <td>
                                    <a href="" class="text-gray-800 text-hover-primary mb-1">{{$quartier->code}}</a>
                                </td>
                                <td>
                                    <a href=""
                                        class="text-gray-800 text-hover-primary mb-1">{{$quartier->designation}}</a>
                                </td>
                                <td>
                                    <a href="" class="text-gray-800 text-hover-primary mb-1">{{$quartier->communesecteurchefferie->designation}}</a>
                                    <span
                                    class="text-muted fw-bold text-muted d-block fs-7">
                                        {{$quartier->communesecteurchefferie->villeterritoires->designation}}
                                    </span>
                                </td>
                                <td>
...
<div class="modal fade" id="add_element_forms" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            @livewire('localisation.add-quartiers')
            <!--end::Form-->
        </div>
    </div>
</div>
