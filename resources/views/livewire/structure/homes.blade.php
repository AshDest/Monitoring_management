    ...
    <div class="col-xl-4">
        ...
        <div class="card card-xl-stretch">
            ...
            <div class="card-header border-0 bg-danger py-5">
                <h3 class="card-title fw-bolder text-white">Statistique de Ventes</h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                ...
                <div class="card-p mt-n20 position-relative">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                            ...
                            <!--end::Svg Icon-->
                            <a href="/{{$structure}}/ventes" class="text-warning fw-bold fs-6">Ventes</a>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
            ...
            <div class="card-body pt-0">
                ...
                <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                    ...
                    <div class="flex-grow-1 me-2">
                        <a href="#"
                            class="fw-bolder text-gray-800 text-hover-primary fs-6">{{$categArticle->designation}}</a>
                        @php
                        $dateUpdate = $categArticle->created_at;
                        $tdate = Carbon\Carbon::now();
                        $datetime1 = new DateTime($dateUpdate);
                        $datetime2 = new DateTime($tdate);
                        $interval = ($datetime1->diff($datetime2)->days < 1)? 'today' : $dateUpdate->
                            diffForHumans($tdate);
                            // $days = $interval->format('%a');//now do whatever you like with $day

                            @endphp
                            <span class="text-muted fw-bold d-block">{{$interval}}</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Lable-->
                    @php
                    // use App\Models\Article;
                    $count = App\Models\Article::where('codeCategorie', $categArticle->id)->count();
                    // dd($categArticle->codeCategorie)
                    @endphp
                    <span class="fw-bolder text-warning py-1">{{$count}}</span>
                    <!--end::Lable-->
                </div>
                @endforeach
