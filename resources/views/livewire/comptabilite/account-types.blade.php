            ...
            <div class="row mb-5">
                <div class="col-md-6 pe-lg-10">
                    <form wire:submit.prevent="save">
                        <div class="row mb-5">
                            <div class="col-md-10 fv-row mb-2">
                            ...
                            <div class="col-md-10 fv-row mb-2">
                                <label class="required fs-5 fw-bold mb-2">Numer ordre (bs_order)</label>
                                <input type="text" wire:model='bs_order' class="form-control form-control-solid"
                                    placeholder="" name="bs_order" />
                            </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">ORDRE (BS ORDER)</th>
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                <tr>
                                    ...
                                    <td>
                                        {{$accounttype->bs_order}}
                                    </td>
                                    <td class="text-end">
                                        <a href="#"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            wire:click="displayInfo({{$accounttype->id}})">
