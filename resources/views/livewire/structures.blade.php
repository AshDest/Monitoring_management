                                    ...
                                    <fieldset>
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input class="form-control form-control-solid" wire:model='avenu'
                                                    placeholder="" name="avenue" />
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-bold mb-2">Code Parcelle</label>
                                                <input class="form-control form-control-solid" wire:model='numParcelle'
                                                    placeholder="" name="numParcelle" />
                                            </div>
                                            <div class="col-md-4 fv-row">
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input class="form-control form-control-solid" wire:model='numTel1'
                                                    placeholder="" name="tel1" />
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-bold mb-2">Numero 2</label>
                                                <input class="form-control form-control-solid" wire:model='numTel2'
                                                    placeholder="" name="tel2" />
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-bold mb-2">Email</label>
                                                <input class="form-control form-control-solid" wire:model='email'
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input class="form-control form-control-solid" wire:model='numImpot'
                                                    placeholder="N°Impot" name="num_impot" />
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-bold mb-2">ID National</label>
                                                <input class="form-control form-control-solid" wire:model='idNational'
                                                    placeholder="ID National" name="id_nat" />
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-bold mb-2">Num CNSS</label>
                                                <input class="form-control form-control-solid" wire:model='numCNSS'
                                                    placeholder="N° CNSS" name="num_cnss" />
                                            </div>
                                        </div>
                                    </fieldset>
